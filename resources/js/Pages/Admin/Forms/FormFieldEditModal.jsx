...
const FormFieldEditModal = ({
  ...
  const handleSubmit = (e) => {
    ...
    if (field) {
      ...
      submit('put', route('admin.forms.fields.update', {
        form: formId,
        field: field.id
      }), {
        preserveScroll: true,
      ...
      // Create new field
      submit('post', route('admin.forms.fields.store', {
        form: formId
      }), {
        preserveScroll: true,
        onSuccess: () => onClose()
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {['select', 'radio', 'checkbox'].includes(data.type) && (
            <div>
              ...
              >
                <CheckIcon className="mr-1 w-4 h-4" /> Add Option
              </button>
            </div>
          )}
